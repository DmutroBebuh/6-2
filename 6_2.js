...
function submitAnswer() {
    ...
    var checkboxes = document.querySelectorAll("input[type=submit]");
    var userAnswers = [];

    checkboxes.forEach(function(submit) {
        var value = submit.checked ? 1 : 0;
...
document.getElementById("checkButton").addEventListener("click", submitAnswer);